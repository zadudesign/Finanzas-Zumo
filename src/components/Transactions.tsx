...
export function Transactions() {
  ...
  return (
    <div className="space-y-6">
      ...
      {isAdding && (
        <form onSubmit={handleSubmit} className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-3xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-5 items-end">
